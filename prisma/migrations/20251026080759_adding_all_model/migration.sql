-- CreateEnum
CREATE TYPE "WalletStatus" AS ENUM ('LOCKED', 'UNDERREVIEW', 'ACTIVE');

-- CreateEnum
CREATE TYPE "Currency" AS ENUM ('USD', 'EUR', 'NGN', 'GBP', 'CAD', 'INR');
...
CREATE TABLE "Wallet" (
    ...
    "status" "WalletStatus" NOT NULL DEFAULT 'LOCKED',
    "chargesEnabled" BOOLEAN NOT NULL DEFAULT false,
    "payoutsEnabled" BOOLEAN NOT NULL DEFAULT false,
    "detailSubmitted" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Token" (
    ...
    "isExpiredAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Wallet_walletRef_key" ON "Wallet"("walletRef");
